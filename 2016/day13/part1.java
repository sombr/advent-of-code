...
class part {
    ...
    public static int bfs(Pos startPos, Pos endPos, int salt) {
    ...
    public static void main(String args[]) {
        ...
        int testSteps = bfs(startPos, new Pos(7, 4), testSalt);
        System.out.printf(">> test steps: %d\n", testSteps);

        int part1Steps = bfs(startPos, new Pos(31, 39), salt);
        System.out.printf(">> part1 steps: %d\n", part1Steps);
    }
}